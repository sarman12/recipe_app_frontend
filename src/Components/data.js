...
export const cuisineDishList = [
  // Indian Cuisine
  { name: "Litti Chokha", image: I01, ingredients: "Wheat flour, sattu, spices, onions, tomatoes", recipe: "1. Prepare litti dough. 2. Stuff with spiced sattu. 3. Bake or roast. 4. Serve with chokha." },
  { name: "Poha Jalebi", image: I02, ingredients: "Flattened rice, mustard seeds, turmeric, curry leaves, jalebi", recipe: "1. Cook poha with spices. 2. Prepare jalebi batter. 3. Fry jalebi. 4. Serve poha with jalebi." },
  { name: "Bikaneri Kachori", image: I03, ingredients: "Refined flour, urad dal, spices", recipe: "1. Prepare dough. 2. Make filling with urad dal. 3. Shape and fry kachoris." },
  { name: "Akki Roti", image: I04, ingredients: "Rice flour, onions, green chilies, curry leaves", recipe: "1. Mix rice flour with spices and water. 2. Shape into rotis. 3. Cook on a griddle." },
  { name: "Chole Bhature", image: I05, ingredients: "Chickpeas, flour, yogurt, spices", recipe: "1. Cook chole with spices. 2. Prepare bhature dough. 3. Fry bhature. 4. Serve with chole." },
  { name: "Khandvi", image: I06, ingredients: "Gram flour, yogurt, spices", recipe: "1. Prepare batter. 2. Cook until thick. 3. Roll and cut into pieces." },
  { name: "Dhokla", image: I07, ingredients: "Rice flour, gram flour, yogurt, spices", recipe: "1. Prepare batter. 2. Steam the batter. 3. Cut and serve with chutney." },
  { name: "Aloo Paratha", image: I08, ingredients: "Wheat flour, potatoes, spices", recipe: "1. Prepare dough. 2. Make filling with spiced potatoes. 3. Shape and cook parathas." },
  { name: "Methi Thepla", image: I09, ingredients: "Wheat flour, fenugreek leaves, spices", recipe: "1. Mix flour with fenugreek and spices. 2. Roll into thin theplas. 3. Cook on a griddle." },
  { name: "Pesarattu", image: I10, ingredients: "Green gram, onions, spices", recipe: "1. Soak and grind green gram. 2. Prepare batter. 3. Cook on a griddle." },
  { name: "Idli-Sambar", image: I11, ingredients: "Rice, urad dal, spices, lentils", recipe: "1. Prepare idli batter. 2. Steam idlis. 3. Cook sambar with lentils and vegetables." },
  { name: "Pongal", image: I12, ingredients: "Rice, moong dal, spices, ghee", recipe: "1. Cook rice and dal with spices. 2. Add ghee and serve hot." },
  { name: "Bisi Bele Bath", image: I13, ingredients: "Rice, lentils, vegetables, spices", recipe: "1. Cook rice and lentils. 2. Add vegetables and spices. 3. Serve with raita." },
  { name: "Medu Vada", image: I14, ingredients: "Urad dal, spices", recipe: "1. Soak and grind urad dal. 2. Shape into vadas. 3. Fry until crispy." },
  { name: "Kacchi Dabeli", image: I15, ingredients: "Pav bread, potato filling, chutneys, spices", recipe: "1. Prepare potato filling. 2. Assemble with chutneys and spices. 3. Serve with garnishes." },
  { name: "Vada Pav", image: I16, ingredients: "Potatoes, spices, pav bread", recipe: "1. Prepare spicy potato filling. 2. Fry vadas. 3. Assemble with pav bread and chutneys." },
  { name: "Samosa", image: I17, ingredients: "Flour, potatoes, peas, spices", recipe: "1. Prepare dough. 2. Make filling with spiced potatoes and peas. 3. Shape and fry samosas." },
  { name: "Pav Bhaji", image: I18, ingredients: "Mixed vegetables, pav bread, spices", recipe: "1. Cook vegetables with spices. 2. Serve with buttered pav bread." },
  { name: "Bhindi Masala", image: I19, ingredients: "Okra, onions, tomatoes, spices", recipe: "1. Cook okra with onions and tomatoes. 2. Add spices and serve hot." },
  // Chinese Cuisine
